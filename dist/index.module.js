...
var useDrag = function useDrag(_a) {
  ...
  var handleClickStartTimerMoveRef = React.useRef(null); // see https://twitter.com/ValentinHervieu/status/1324407814970920968
  ...
  var moveStart = React.useCallback(function (e) {
...
var SortableList = function SortableList(_a) {
  var children = _a.children,
      ...
      rest = __rest(_a, ["children", "allowDrag", "onSortEnd", "draggedItemClassName", "as", "lockAxis", "customHolderRef"]); // this array contains the elements than can be sorted (wrapped inside SortableItem)
